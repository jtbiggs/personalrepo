...
a=0;
b=2;
N=21; %this generates N splines
[Basis,D_Basis,DD_Basis,ClampedBasis,D_ClampedBasis,DD_ClampedBasis,ClampedBMBBasis,D_ClampedBMBBasis,DD_ClampedBMBBasis,BMBBasis,D_BMBBasis,DD_BMBBasis,xarr,~]=cubicbspline2(a,b,N);
%[~,~,~,~,~,~,y,~,~,x,~]=cubicbspline(a,b,N);
figure
%x=linspace(4,8,24000);
plot(xarr,BMBBasis)
title('Cubic b-spline BMB Basis')
axis([0 2 -8 5]);
%xticks([4 5 6 7 8])
